...
<a href="assets/files/mardown_file_from_letter.Rmd" class="btn flushfooter"><i class="icon-envelope"></i> Attachment</a>
...
> where the code is executed and replaced. Just install the  
> `knitr` package and hit the knit to HTML button in your RStudio!  
> -- *All the best Karl*  
...
## Markdown Syntax (header/lists)

* Headers (conterpart: `<h1..x>Text</h1..x>`)
...
* Numbered list (digits, counterpart: `<ol><li>Element one</li></ol>`) 
...
You can nest lists with TAB indent
...
* A metadata part
  * title, author, and date, output (pdf, html)
  * In beginning of document
...
1. Edit the metadata .Rmd and remove the rest
1. Save the file somewhere (own folder)
